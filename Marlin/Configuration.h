...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,633} //Calibrated 12 Jan 2017 674*(110mm-3.5mm)/100mm. 200*16*32/(8*3.1415926*10.8) } // Prusa Compact 8 to 32 gears, Mk8 6.7 mm hobbed pulley// X, Y, Z, E steps per unit - Metric Prusa Mendel with Wade extruder:
