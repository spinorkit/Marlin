...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.7 //-0.4   // Z offset: -below +above  [the nozzle]
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   3//10 // Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES  1//5 // Z Clearance between probe points
